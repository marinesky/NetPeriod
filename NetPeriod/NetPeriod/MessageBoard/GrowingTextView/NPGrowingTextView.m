...
#import "NPTextViewInternal.h"

@interface NPGrowingTextView(private)
-(void)commonInitialiser;
-(void)resizeTextView:(NSInteger)newSizeH;
-(void)growDidStop;
@end

@implementation NPGrowingTextView
...
-(void)commonInitialiser
{
    ...
    r.origin.y = 0;
    r.origin.x = 0;
    internalTextView = [[NPTextViewInternal alloc] initWithFrame:r];
