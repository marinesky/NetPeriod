...
//    [loverDetailTableViewCell addSubview:loverHeaderPictureView];
    selfDetailTableViewCell.imageView.image   = [UIImage imageNamed:[NSString stringWithFormat:@"%@.bmp", userGender]];
    loverDetailTableViewCell.imageView.image  = [UIImage imageNamed:[NSString stringWithFormat:@"%@.bmp", loverGender]];
