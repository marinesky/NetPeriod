...
@property (nonatomic, strong) NPDateItem *dateItem;
...
- (void)_init:(NPCalendarStartDay)firstDay {
...
- (void)setCalendarStartDay:(NPCalendarStartDay)calendarStartDay {
...
- (void)setMonthButtonColor:(UIColor *)color {
    [self.prevButton setImage:[NPCalendarView _imageNamed:@"left_arrow.png" withColor:color] forState:UIControlStateNormal];
    [self.nextButton setImage:[NPCalendarView _imageNamed:@"right_arrow.png" withColor:color] forState:UIControlStateNormal];
}
